<template>
  <div class="content">
    <div class="user-profile-container">
      ...
      <div class="user-name" v-motion-slide-left style="white-space: pre-wrap;">
        <h1>👋Hi,I'm <span class="name-style">{{ userName }}✨️</span></h1>
        <h1>&nbsp;&nbsp;&nbsp;&nbsp;欢迎光临我的主页~~</h1>
      </div>
    </div>
    ...
    <div class="contact-section" v-motion-pop>
      ...
      <span class="contact-item" @click="toggleDarkMode" :style="{ '--hover-color': isDarkMode ? '#ffcc00' : '#666' }">
        ...
        <span class="tooltip">{{ isDarkMode ? '浅色☀️' : '深色😴' }}</span>
      </span>
    </div>
    <Website /> 
    <VisitTimer />
